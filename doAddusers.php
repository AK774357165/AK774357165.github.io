...
$psd1 = isset($_POST['password1'])?$_POST['password1']:'';
$psd2 = isset($_POST['password2'])?$_POST['password2']:'';
...
//准备sql语句
$sql = "INSERT usersinfo(username,idnumber,workshop,job,tel,address,email,password) values ('$user','$idnumber','$workshop','$job','$tel','$address','$email','$psd')";
